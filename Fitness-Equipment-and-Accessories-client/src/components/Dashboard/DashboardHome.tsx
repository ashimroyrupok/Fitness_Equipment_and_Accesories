  ...
  return (
    <div className="mb-10 lg:mb-0">
      <div className="grid grid-cols-1 flex-wrap md:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-5">
        <div className="flex justify-center items-center p-4 md:p-5 lg:p-5  bg-[#283046] rounded-md gap-4 md:gap-5 lg:gap-5">
      ...
      <div className="bg-[#283046]  p-4 mt-5  example h-[56vh] w-[390px] md:w-[730px] lg:w-full rounded-md">
