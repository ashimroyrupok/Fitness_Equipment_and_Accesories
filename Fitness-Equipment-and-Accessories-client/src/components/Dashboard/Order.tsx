...
const Order = () => {
  return (
    <div>
      <div className="bg-[#283046] p-4 lg:mt-5 rounded-md">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-white">Recent Orders</h2>
          <select
            className="border outline-none border-gray-300 px-2 py-2"
            name=""
            id=""
          >
        ...
        <div className="pt-4">
          <div className="bg-[#283046] userOrderDash w-[365px] md:w-[700px] lg:w-full rounded-md">
