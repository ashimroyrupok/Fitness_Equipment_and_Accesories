...
import rocket from "@/assets/react.svg";
    ...
    <div className="bg-[#F6F6F5">
      <Container>
        <div className="max-w-4xl mx-auto  p-5  py-5">
          <h1 className="text-xl text-white font-medium my-2">Pay with Mobile Banking </h1>
          <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-5 rounded-lg  border cursor-pointer w-full ">
            <div
              onClick={() => setTab("stripe")}
              className={`${
                tab === "stripe" ? "bg-whit" : "bg-teal-50"
              } h-32 w-full border-r-2 relative border-slate-200 flex flex-col  justify-center items-center bg-whit`}
            >
          ...
          <div>
            <h1 className="text-xl text-white font-medium my-2">Cash On Delivery</h1>
            <div className="space-y-2 mx-auto text-cente border w-[150px] inline-block">
              <img
                className="mx-auto  w- p-5 rounded-lg mb-"
                src="https://www.shutterstock.com/image-vector/promotional-label-sticker-stamp-cash-600nw-264021485.jpg"
                alt=""
              />
              <h3 className="font-medium text-cente mx-aut text-slate-600 m text-xl  bottom-">
                Stripe
              </h3>
            </div>
          </div>
